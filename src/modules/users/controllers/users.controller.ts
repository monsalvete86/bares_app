...
export class UsersController {
  ...
  @ApiQuery({ name: 'username', required: false, type: String, description: 'Filtrar por nombre de usuario' })
  @ApiQuery({ name: 'fullName', required: false, type: String, description: 'Filtrar por nombre completo' })
